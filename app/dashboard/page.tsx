...
import { getWhitelist, getBlacklist, setWhitelist, setBlacklist, getCustomInstructions, setCustomInstructions } from 'app/db';
...
const updateCustomInstructions = async (...args: Parameters<typeof setCustomInstructions>) => {
  'use server'
    ...
    <>
      <div className="min-h-screen bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-12">Flavor Preferences</h1>
